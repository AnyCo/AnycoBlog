...
public class QuartzManager {
    ...
    private static String JOB_GROUP_NAME = "EMAIL_JOBGROUP_NAME";
    private static String TRIGGER_GROUP_NAME = "EMAIL_TRIGGERGROUP_NAME";
    ...
    public static void modifyJobTime(String jobName, String time) {
        try {
            ...
            if (!oldTime.equalsIgnoreCase(time)) {
                ...
                addJob(jobName, jobClass, time, new HashMap<String, String>());
            }
        } catch (Exception e) {
            e.printStackTrace();
            throw new RuntimeException(e);
